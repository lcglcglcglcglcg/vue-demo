...
Vue.directive('drag-modal', (el, binding, vnode, oldVnode) => {
  Vue.nextTick(() => {
    ...
    dialogHeaderEl.onmousedown = (e) => {
      ...
      console.log('disY: ', disX, disY, dialogHeaderEl.offsetLeft, dialogHeaderEl.offsetTop);

      const screenWidth = document.body.clientWidth // body当前宽度
      const screenHeight = document.documentElement.clientHeight // 可见区域高度(应为body高度，可某些环境下无法获取)
      const dragDomWidth = dragDom.offsetWidth // 对话框宽度
      const dragDomheight = dragDom.offsetHeight // 对话框高度
      console.log('dragDomWidth: ', dragDomWidth, dragDomheight);
      ...
      console.log('minDragDomLeft: ', minDragDomLeft, maxDragDomLeft, minDragDomTop, maxDragDomTop);
      // 获取到的值带px 正则匹配替换
