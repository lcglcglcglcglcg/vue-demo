  ...
  <div class="login-container">
    ...
    <div class="login-plane">
      <div class="login-plane-container">
        <img class="login-plane-human" src="./images/login_human.png" alt="" />
        <div class="login-plane-title">
          小楼一夜听春雨 -- 登陆
          <img class="login-plane-title-line" src="./images/login_horizontal_line.png" alt="" />
        </div>
        <div class="login-plane-form">
          <a-form-model :model="formField" :rules="formRules" ref="formRef">
            <a-form-model-item prop="user">
              <a-input placeholder="用户名 / 账号" type="text" v-model="formField.user"></a-input>
            </a-form-model-item>
            <a-form-model-item prop="pass">
              <a-input placeholder="密码" type="password" v-model="formField.pass"></a-input>
            </a-form-model-item>
            <div class="login-code-container">
              <a-form-model-item style="width: 50%" prop="code">
                <a-input placeholder="验证码" type="text" v-model="formField.code"></a-input>
              </a-form-model-item>
              <div @click="getValidateCodeHandle" class="login-code">
                <img :src="state.codeSrc" />
              </div>
            </div>
            <a-form-model-item prop="autoLogin">
              <a-checkbox v-model="formField.whetherAutoLogin">
                <span style="color: #fff">自动登陆</span>
              </a-checkbox>
            </a-form-model-item>
          </a-form-model>
...
export default {
  ...
  methods: {
    ...
    initSceneBg() {
      new THREE.TextureLoader().load(require('./images/sky.png'), (texture) => {
    ...
    initSphereModal() {
      ...
      material.map = new THREE.TextureLoader().load(require('./images/earth_bg.png'))
    ...
    // 渲染星星的运动
    // 星星的运动效果，实际就是沿着z轴从远处不断朝着相机位置移动，直到移出相机的位置时回到起点，
    renderStarMove() {
