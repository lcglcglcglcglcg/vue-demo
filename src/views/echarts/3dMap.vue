...
export default {
  ...
  methods: {
    init() {
      ...
      let option = {
        ...
        series: [
          ...
          },
          {
            ...
            zlevel: 3,
            symbol:
              'path://m232.99844,160.209511l15.863519,0l0,-14.211071l16.27296,0l0,14.211071l15.863521,0l0,14.577861l-15.863521,0l0,14.211069l-16.27296,0l0,-14.211069l-15.863519,0l0,-14.577861z',
            //symbol: 'circle',
            symbolSize: 16,
      ...
      this.myEchart.on('click', (params) => this.myEchart.getOption())
    },
  },
}
</script>
