  ...
  data() {
    return {
      ...
      mapIconData: {
        ...
        icon: require('./image/logo.png'), // 文件地址 String[url] ，必须 ，默认为 null，
      ...
      mapOverlayData: {
        ...
        img: require('./image/hot.gif'), // slot
      },
      // 海量点图层数据
      mapPointCollectionData: {
        ...
        bgImg: require('./image/mark.png'), // 设置背景图，如果设置了此那么文字背景可以不设置
      },
      mapCircleData: {
      ...
      clickCenter: [0, 0],
      popupText: '弹窗初始化文字',
      iconImg: require('./image/mark.png'), // 文件地址 String[url]
      pointlist: [
