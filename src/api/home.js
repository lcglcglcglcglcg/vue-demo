import { getAction, deleteAction, putAction, postAction, httpAction } from '@/api/common'
import Qs from 'qs'
...
export const location = (l, b) => postAction('cors/cover/location', Qs.stringify({ l, b }))
